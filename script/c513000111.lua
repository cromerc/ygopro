--最終突撃命令
function c513000111.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_TOGRAVE)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetTarget(c513000111.target)
	e1:SetOperation(c513000111.activate)
	c:RegisterEffect(e1)
	--Pos Change
...
function c513000111.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c513000111.activate(e,tp,eg,ep,ev,re,r,rp)
