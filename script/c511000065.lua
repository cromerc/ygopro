...
function c511000065.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511000065.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local d=Duel.GetAttackTarget()
	local ct=0
	while ct<3 and Duel.IsPlayerCanDiscardDeck(tp,1) and (ct==0 or Duel.SelectYesNo(tp,aux.Stringid(511000065,0))) do
