...
function c110000000.initial_effect(c)
	...
	e3:SetProperty(EFFECT_FLAG_UNCOPYABLE+EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_INITIAL)
	e3:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_TRIGGER_F)
	e3:SetCountLimit(1)
	e3:SetRange(LOCATION_SZONE)
	e3:SetCode(EVENT_PHASE+PHASE_STANDBY)
	e3:SetCondition(c110000000.ctcon)
	e3:SetTarget(c110000000.cttg)
	...
	e5:SetRange(LOCATION_SZONE+LOCATION_REMOVED)
...
function c110000000.ctcon2(e)
	if e:GetHandler():GetFlagEffect(100100103)==0 then return 1
...
function c110000000.op(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if Duel.GetMatchingGroup(c110000000.filter,tp,LOCATION_HAND+LOCATION_DECK,0,nil):GetCount()>39
	 and tc==nil then
...
function c110000000.ctcon(e)
	local g=Duel.GetMatchingGroup(Card.IsHasEffect,e:GetHandler():GetControler(),0,LOCATION_MZONE,nil,100100090)
	return e:GetHandler():GetFlagEffect(100100108)==0 and g:GetCount()==0
	 and e:GetHandler():IsLocation(LOCATION_SZONE)
end
function c110000000.cttg(e,tp,eg,ep,ev,re,r,rp,chk)
