--Ｓｐ－フォース
function c100100016.initial_effect(c)
	--Activate
	...
	e1:SetCost(c100100016.cost)
	e1:SetTarget(c100100016.target)
	e1:SetOperation(c100100016.activate)
	c:RegisterEffect(e1)
end
function c100100016.cost(e,tp,eg,ep,ev,re,r,rp,chk)
