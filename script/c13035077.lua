...
function c13035077.atktg(e,c)
	return c:IsSetCard(0xf9) or c:IsCode(30539496,34079868,82321037,87765315,96746083)
end
function c13035077.indtg(e,c)
	return bit.band(c:GetSummonType(),SUMMON_TYPE_ADVANCE)==SUMMON_TYPE_ADVANCE and (c:IsSetCard(0xf9) or c:IsCode(30539496,34079868,82321037,87765315,96746083))
end
...
function c13035077.thfilter(c)
	return (c:IsSetCard(0xf9) or c:IsCode(30539496,34079868,82321037,87765315,96746083)) and c:IsAbleToHand()
end
