--フォトン・カイザー
function c511002849.initial_effect(c)
	...
	c:RegisterEffect(e1)
	if not c511002849.global_check then
		c511002849.global_check=true
		local ge2=Effect.CreateEffect(c)
		ge2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		ge2:SetCode(EVENT_ADJUST)
		ge2:SetCountLimit(1)
		ge2:SetProperty(EFFECT_FLAG_NO_TURN_RESET)
		ge2:SetOperation(c511002849.xyzchk)
		Duel.RegisterEffect(ge2,0)
	end
end
function c511002849.xyzchk(e,tp,eg,ep,ev,re,r,rp)
