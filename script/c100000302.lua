--Ｔｈｅ ｇｒａｎｄ ＪＵＰＩＴＥＲ
function c100000302.initial_effect(c)
	--equip
	...
	e1:SetCost(c100000302.spcost)
	e1:SetTarget(c100000302.eqtg)
	e1:SetOperation(c100000302.eqop)
	c:RegisterEffect(e1)
end
function c100000302.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c100000302.eqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c100000302.eqlimit(e,c)
	return e:GetOwner()==c
end
function c100000302.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		if c:IsFaceup() and c:IsRelateToEffect(e) then
			...
			e1:SetValue(c100000302.eqlimit)
