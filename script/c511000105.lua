--マスドライバー
function c511000105.initial_effect(c)
	--Activate
	...
	e2:SetCost(c511000105.damcost)
	e2:SetTarget(c511000105.damtg)
	e2:SetOperation(c511000105.damop)
	c:RegisterEffect(e2)
end
...
function c511000105.damop(e,tp,eg,ep,ev,re,r,rp)
