--Xyz Treasure Ticket
function c511000866.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511000866.target)
	e1:SetOperation(c511000866.operation)
	c:RegisterEffect(e1)
end
...
function c511000866.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c511000866.filter,tp,LOCATION_MZONE,0,1,nil) and Duel.IsPlayerCanDraw(tp,1) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_FACEUP)
	local g=Duel.SelectTarget(tp,c511000866.filter,tp,LOCATION_MZONE,0,1,1,nil)
