--Bye Bye Damage
function c511001567.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e1:SetTarget(c511001567.target)
	e1:SetOperation(c511001567.activate)
	c:RegisterEffect(e1)
end
function c511001567.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511001567.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) then
		...
		e2:SetCondition(c511001567.damcon)
		e2:SetOperation(c511001567.damop)
		e2:SetReset(RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END)
		tc:RegisterEffect(e2)
	end
end
function c511001567.damcon(e,tp,eg,ep,ev,re,r,rp)
	return ep==tp and e:GetHandler():IsRelateToBattle()
end
function c511001567.damop(e,tp,eg,ep,ev,re,r,rp)
