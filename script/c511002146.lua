...
function c511002146.initial_effect(c)
	...
	e1:SetTarget(c511002146.target)
	e1:SetOperation(c511002146.operation)
	c:RegisterEffect(e1)
	--sp summon
...
function c511002146.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511002146.operation(e,tp,eg,ep,ev,re,r,rp)
