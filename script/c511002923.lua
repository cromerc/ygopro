--Fair Exchange
function c511002923.initial_effect(c)
	--discard deck
	...
	e1:SetTarget(c511002923.target)
	e1:SetOperation(c511002923.activate)
	c:RegisterEffect(e1)
end
function c511002923.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511002923.activate(e,tp,eg,ep,ev,re,r,rp)
