--Gorgon Charm
function c511002929.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511002929.target)
	e1:SetOperation(c511002929.activate)
	c:RegisterEffect(e1)
end
function c511002929.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511002929.activate(e,tp,eg,ep,ev,re,r,rp)
