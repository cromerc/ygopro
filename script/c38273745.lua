...
function c38273745.initial_effect(c)
	...
	e1:SetProperty(EFFECT_FLAG2_XMDETACH+EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_NO_TURN_RESET)
	...
	e2:SetProperty(EFFECT_FLAG2_XMDETACH+EFFECT_FLAG_NO_TURN_RESET)
	...
	e3:SetProperty(EFFECT_FLAG2_XMDETACH+EFFECT_FLAG_CARD_TARGET+EFFECT_FLAG_NO_TURN_RESET)
