...
function c511001694.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(511001694,0))
	...
	c:RegisterEffect(e1)
	c511001694.spe=e1
	if not c511001694.global_check then
		c511001694.global_check=true
		local ge2=Effect.CreateEffect(c)
		ge2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		ge2:SetCode(EVENT_ADJUST)
		ge2:SetCountLimit(1)
		ge2:SetProperty(EFFECT_FLAG_NO_TURN_RESET)
		ge2:SetOperation(c511001694.cardchk)
		Duel.RegisterEffect(ge2,0)
	end
end
function c511001694.spcon(c,e)
	if c==nil or not e then return false end
	local tp=c:GetControler()
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-1 and Duel.CheckReleaseGroup(tp,c511001694.filter,1,nil) 
...
function c511001694.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c511001694.filter,1,nil) end
	local g=Duel.SelectReleaseGroup(tp,c511001694.filter,1,1,nil)
...
function c511001694.cardchk(e,tp,eg,ep,ev,re,r,rp)
