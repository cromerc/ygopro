--機皇兵スキエル・アイン
function c511002528.initial_effect(c)
	--Negate Damage
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_QUICK_O)
	e1:SetCode(EVENT_CHAINING)
	e1:SetRange(LOCATION_MZONE)
	e1:SetCondition(c511002528.con)
	e1:SetOperation(c511002528.op)
	c:RegisterEffect(e1)
end
function c511002528.con(e,tp,eg,ep,ev,re,r,rp)
...
function c511002528.op(e,tp,eg,ep,ev,re,r,rp,val,r,rc)
	...
	e1:SetLabel(cid)
	e1:SetValue(c511002528.refcon)
	e1:SetReset(RESET_CHAIN)
	Duel.RegisterEffect(e1,tp)
end
function c511002528.refcon(e,re,val,r,rp,rc)
