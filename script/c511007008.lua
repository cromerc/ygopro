...
function c511007008.initial_effect(c)
	...
	e1:SetTarget(c511007008.target)
	e1:SetOperation(c511007008.activate)
	c:RegisterEffect(e1)
	--act in hand
...
function c511007008.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511007008.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		...
		e1:SetCountLimit(1)
		e1:SetValue(function(e,re,r,rp) return bit.band(r,REASON_BATTLE)~=0 end)
