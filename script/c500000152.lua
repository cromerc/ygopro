--呪詛返しのヒトガタ
function c500000152.initial_effect(c)
	--reflect
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetProperty(EFFECT_FLAG_DAMAGE_STEP)
	e1:SetCode(EVENT_CHAINING)
	e1:SetCondition(c500000152.condition)
	e1:SetOperation(c500000152.operation)
	c:RegisterEffect(e1)
end
function c500000152.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c500000152.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetLabel(cid)
	e1:SetValue(c500000152.refcon)
	e1:SetReset(RESET_CHAIN)
	Duel.RegisterEffect(e1,tp)
end
function c500000152.refcon(e,re,val,r,rp,rc)
