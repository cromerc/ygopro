...
function c100000050.initial_effect(c)
	...
	e1:SetValue(c100000050.operation)
	c:RegisterEffect(e1)
	--defup
	local e2=e1:Clone()
...
function c100000050.filter(c)
	return c:IsFaceup() and (c:IsSetCard(0x300) or c100000050.collection[c:GetCode()])
end
function c100000050.operation(e,c)
	local wup=0
...
function c100000050.eqlimit(e,c)
	return e:GetOwner()==c
end
function c100000050.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) then
		if c:IsFaceup() and c:IsRelateToEffect(e) then
			...
			e1:SetValue(c100000050.eqlimit)
