--Hell Fly Nest
function c511000796.initial_effect(c)
	--damage
	...
	e1:SetTarget(c511000796.damtg)
	e1:SetOperation(c511000796.damop)
	c:RegisterEffect(e1)
end
function c511000796.damtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511000796.damop(e,tp,eg,ep,ev,re,r,rp)
