...
function c82821760.initial_effect(c)
	...
	e6:SetCondition(c82821760.descon)
	e6:SetTarget(c82821760.destg)
	e6:SetOperation(c82821760.desop)
	c:RegisterEffect(e6)
	--to deck
	local e7=Effect.CreateEffect(c)
	e7:SetDescription(aux.Stringid(82821760,3))
	e7:SetCategory(CATEGORY_TODECK)
	e7:SetType(EFFECT_TYPE_IGNITION)
	e7:SetRange(LOCATION_GRAVE)
	e7:SetCost(c82821760.tdcost)
	e7:SetTarget(c82821760.tdtg)
	e7:SetOperation(c82821760.tdop)
	c:RegisterEffect(e7)
end
