...
function c511000123.initial_effect(c)
	...
	e1:SetCountLimit(1)
	e1:SetTarget(c511000123.tg)
	e1:SetOperation(c511000123.op)
	c:RegisterEffect(e1)
	--maintain
	...
	e3:SetCountLimit(1)
	e3:SetCondition(c511000123.mtcon)
	e3:SetOperation(c511000123.mtop)
	c:RegisterEffect(e3)
end
function c511000123.tg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511000123.op(e,tp,eg,ep,ev,re,r,rp)
	local dg=Duel.GetDecktopGroup(tp,1):GetFirst()
...
function c511000123.mtcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetTurnPlayer()==tp
end
function c511000123.mtop(e,tp,eg,ep,ev,re,r,rp)
