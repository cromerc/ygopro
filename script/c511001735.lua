--Volcanic Ash
function c511001735.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511001735.target)
	e1:SetOperation(c511001735.activate)
	c:RegisterEffect(e1)
end
function c511001735.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511001735.activate(e,tp,eg,ep,ev,re,r,rp)
