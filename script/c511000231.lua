...
function c511000231.initial_effect(c)
	...
	e1:SetCondition(c511000231.con)
	e1:SetCost(c511000231.cost)
	e1:SetTarget(c511000231.tg)
	e1:SetOperation(c511000231.op)
	c:RegisterEffect(e1)
	--battle indestructable
	local e2=Effect.CreateEffect(c)
	e2:SetType(EFFECT_TYPE_SINGLE)
	e2:SetCode(EFFECT_INDESTRUCTABLE_BATTLE)
	e2:SetValue(c511000231.indes)
	c:RegisterEffect(e2)
end
