--手札断殺
function c511002601.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_DRAW)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetTarget(c511002601.target)
	e1:SetOperation(c511002601.activate)
	c:RegisterEffect(e1)
end
function c511002601.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
