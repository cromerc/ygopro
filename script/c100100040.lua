--Ｓｐ－強制転移
function c100100040.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_CONTROL)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetCost(c100100040.cost)
	e1:SetTarget(c100100040.target)
	e1:SetOperation(c100100040.activate)
	c:RegisterEffect(e1)
end
function c100100040.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c100100040.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c100100040.activate(e,tp,eg,ep,ev,re,r,rp)
