--Negate Defense
function c511000176.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511000176.target)
	e1:SetOperation(c511000176.activate)
	c:RegisterEffect(e1)
end
function c511000176.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511000176.activate(e,tp,eg,ep,ev,re,r,rp)
