...
function c511002542.initial_effect(c)
	...
	e1:SetTarget(c511002542.target)
	e1:SetOperation(c511002542.operation)
	c:RegisterEffect(e1)
	--Atk
...
function c511002542.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511002542.operation(e,tp,eg,ep,ev,re,r,rp)
