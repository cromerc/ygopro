--Life Regeneration
function c511001241.initial_effect(c)
	--reflect
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_CHAINING)
	e1:SetCondition(c511001241.condition)
	e1:SetOperation(c511001241.operation)
	c:RegisterEffect(e1)
end
function c511001241.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c511001241.operation(e,tp,eg,ep,ev,re,r,rp)
