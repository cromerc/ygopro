...
function c511001572.initial_effect(c)
	...
	e1:SetTarget(c511001572.target)
	e1:SetOperation(c511001572.operation)
	c:RegisterEffect(e1)
	--Equip limit
...
function c511001572.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511001572.operation(e,tp,eg,ep,ev,re,r,rp)
