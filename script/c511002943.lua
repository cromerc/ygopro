...
function c511002943.initial_effect(c)
	...
	e1:SetTarget(c511002943.target)
	e1:SetOperation(c511002943.operation)
	c:RegisterEffect(e1)
	--Equip limit
...
function c511002943.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511002943.operation(e,tp,eg,ep,ev,re,r,rp)
