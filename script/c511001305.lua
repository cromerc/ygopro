...
function c511001305.initial_effect(c)
	...
	e4:SetCondition(c511001305.incon)
	e4:SetTarget(c511001305.infilter)
	c:RegisterEffect(e4)
end
function c511001305.cfilter(c,code)
	return c:IsFaceup() and c:IsCode(code)
end
function c511001305.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c511001305.cfilter,tp,LOCATION_SZONE,0,1,nil,511001306)
		and Duel.IsExistingMatchingCard(c511001305.cfilter,tp,LOCATION_SZONE,0,1,nil,29762407)
end
...
function c511001305.incon(e)
	return Duel.IsExistingMatchingCard(c511001305.cfilter,e:GetHandlerPlayer(),LOCATION_ONFIELD,0,1,nil,511001306)
end
function c511001305.infilter(e,c)
