...
function c511001697.initial_effect(c)
	...
	e1:SetCost(c511001697.spcost)
	e1:SetTarget(c511001697.sptg)
	e1:SetOperation(c511001697.spop)
	c:RegisterEffect(e1)
	c511001697.spe=e1
	if not c511001697.global_check then
		c511001697.global_check=true
		local ge2=Effect.CreateEffect(c)
		ge2:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
		ge2:SetCode(EVENT_ADJUST)
		ge2:SetCountLimit(1)
		ge2:SetProperty(EFFECT_FLAG_NO_TURN_RESET)
		ge2:SetOperation(c511001697.cardchk)
		Duel.RegisterEffect(ge2,0)
	end
end
function c511001697.spcon(c,e)
...
function c511001697.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c511001697.filter,1,nil) end
	local g=Duel.SelectReleaseGroup(tp,c511001697.filter,1,1,nil)
...
function c511001697.cardchk(e,tp,eg,ep,ev,re,r,rp)
