...
function c100000364.initial_effect(c)
	...
	e1:SetTarget(c100000364.target)
	e1:SetOperation(c100000364.operation)
	c:RegisterEffect(e1)
	--Equip limit
...
function c100000364.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c100000364.operation(e,tp,eg,ep,ev,re,r,rp)
