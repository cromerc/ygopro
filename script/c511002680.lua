--ポイズンマミー
function c511002680.initial_effect(c)
	--flip
	...
	e1:SetTarget(c511002680.target)
	e1:SetOperation(c511002680.operation)
	c:RegisterEffect(e1)
end
function c511002680.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511002680.operation(e,tp,eg,ep,ev,re,r,rp)
