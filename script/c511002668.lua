--Insect Luring Light
function c511002668.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511002668.target)
	e1:SetOperation(c511002668.activate)
	c:RegisterEffect(e1)
end
function c511002668.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511002668.activate(e,tp,eg,ep,ev,re,r,rp)
