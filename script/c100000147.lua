...
function c100000147.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and c100000147.filter(chkc) end
...
function c100000147.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and tc:IsFaceup() then
		tc:RegisterFlagEffect(100000147,RESET_EVENT+0x1fe0000+RESET_PHASE+RESET_END,0,1) 	
	end
end