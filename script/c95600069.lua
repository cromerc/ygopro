...
function c95600069.initial_effect(c)
	...
	e2:SetCondition(c95600069.furycon)
	e2:SetValue(400)
	c:RegisterEffect(e2)
	--Turn into Crystal
	local e3=Effect.CreateEffect(c)
	e3:SetDescription(aux.Stringid(95600069,0))
	e3:SetCode(EFFECT_SEND_REPLACE)
	e3:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e3:SetProperty(EFFECT_FLAG_SINGLE_RANGE+EFFECT_FLAG_UNCOPYABLE)
	e3:SetRange(LOCATION_MZONE)
	e3:SetTarget(c95600069.crystaltg)
	e3:SetOperation(c95600069.crystalop)
	c:RegisterEffect(e3)
end
function c95600069.crystaltg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c95600069.crystalop(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
