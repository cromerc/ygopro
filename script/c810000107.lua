...
function c810000107.initial_effect(c)
	...
	e1:SetOperation(c810000107.operation)
	c:RegisterEffect(e1)
	--
	local e2=e1:Clone()
	e2:SetCode(EVENT_CHAINING)
	e2:SetCondition(c810000107.condition2)
	c:RegisterEffect(e2)
end
function c810000107.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	if not tc:IsSetCard(0xad) then return false end
	e:SetLabelObject(tc)
...
function c810000107.operation(e,tp,eg,ep,ev,re,r,rp)
