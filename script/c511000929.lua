--Oberon's Prank
function c511000929.initial_effect(c)
	--reflect
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetProperty(EFFECT_FLAG_DAMAGE_STEP)
	e1:SetCode(EVENT_CHAINING)
	e1:SetCondition(c511000929.condition)
	e1:SetOperation(c511000929.operation)
	c:RegisterEffect(e1)
end
function c511000929.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c511000929.operation(e,tp,eg,ep,ev,re,r,rp)
