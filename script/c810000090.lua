...
function c810000090.initial_effect(c)
	...
	e1:SetTarget(c810000090.target)
	e1:SetOperation(c810000090.operation)
	c:RegisterEffect(e1)
	--Pierce
...
function c810000090.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c810000090.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_EQUIP)
	Duel.SelectTarget(tp,c810000090.filter,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil)
	Duel.SetOperationInfo(0,CATEGORY_EQUIP,e:GetHandler(),1,0,0)
end
function c810000090.operation(e,tp,eg,ep,ev,re,r,rp)
