--Doll Hammer
function c511001470.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511001470.target)
	e1:SetOperation(c511001470.activate)
	c:RegisterEffect(e1)
end
function c511001470.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511001470.activate(e,tp,eg,ep,ev,re,r,rp)
