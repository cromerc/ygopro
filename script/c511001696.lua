...
function c511001696.initial_effect(c)
	c:EnableUnsummonable()
	--spsummon
	local e1=Effect.CreateEffect(c)
	e1:SetDescription(aux.Stringid(511001696,0))
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON+CATEGORY_DRAW)
	e1:SetType(EFFECT_TYPE_IGNITION)
	e1:SetRange(LOCATION_HAND)
	e1:SetCost(c511001696.spcost)
	e1:SetTarget(c511001696.sptg)
...
function c511001696.spcon(c,e)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-1 and Duel.CheckReleaseGroup(tp,c511001696.filter,1,nil) 
...
function c511001696.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	local g=Duel.SelectReleaseGroup(tp,c511001696.filter,1,1,nil)
	Duel.Release(g,REASON_COST)
end
function c511001696.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511001696.spop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
