--ＤＴ スパイダー・コクーン
function c100000144.initial_effect(c)
	--synchro summon
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_SINGLE)
	e1:SetCode(EFFECT_CANNOT_BE_SYNCHRO_MATERIAL)
	e1:SetProperty(EFFECT_FLAG_CANNOT_DISABLE+EFFECT_FLAG_UNCOPYABLE)
	e1:SetValue(c100000144.synlimit)
	c:RegisterEffect(e1)	
	--special summon
	...
	e2:SetCondition(c100000144.spcon)
	c:RegisterEffect(e2)
end
function c100000144.synlimit(e,c)
