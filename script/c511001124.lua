...
function c511001124.eqtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_GRAVE) and chkc:IsControler(tp) and c511001124.filter(chkc) end
...
function c511001124.eqop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsFaceup() and c:IsRelateToEffect(e) and tc and tc:IsRelateToEffect(e) then
		...
		e1:SetValue(c511001124.eqlimit)
...
function c511001124.eqlimit(e,c)
	return e:GetOwner()==c
end
