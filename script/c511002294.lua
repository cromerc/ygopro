--Excavation Work
function c511002294.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511002294.target)
	e1:SetOperation(c511002294.activate)
	c:RegisterEffect(e1)
end
function c511002294.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(Card.IsAbleToGrave,tp,LOCATION_HAND,0,1,nil) end
	Duel.SetTargetPlayer(tp)
	Duel.SetTargetParam(1)
	Duel.SetOperationInfo(0,CATEGORY_TOGRAVE,nil,1,tp,LOCATION_HAND)
end
function c511002294.activate(e,tp,eg,ep,ev,re,r,rp)
