--Flip Flap
function c511002564.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511002564.target)
	e1:SetOperation(c511002564.activate)
	c:RegisterEffect(e1)
end
function c511002564.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511002564.activate(e,tp,eg,ep,ev,re,r,rp)
