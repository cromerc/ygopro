...
function c95000084.initial_effect(c)
	...
	e7:SetTarget(c95000084.sfilter)
	c:RegisterEffect(e7)
	-- Add Action Card
	...
	e9:SetTarget(aux.TargetBoolFunction(Card.IsRace,RACE_DINOSAUR))
	e9:SetCondition(c95000084.Fcond)
	e9:SetValue(150)
	c:RegisterEffect(e9)
	--Def
	...
	e10:SetTarget(aux.TargetBoolFunction(Card.IsRace,RACE_DINOSAUR))
	e10:SetCondition(c95000084.Fcond)
	e10:SetValue(150)
...
function c95000084.sfilter(e,c,tp)
...
function c95000084.returnop(e)
	...
	e4:SetTarget(c95000084.sfilter)
