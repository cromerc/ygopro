...
function c511000835.initial_effect(c)
	...
	e1:SetTarget(c511000835.target)
	e1:SetOperation(c511000835.operation)
	c:RegisterEffect(e1)
	--equip limit
...
function c511000835.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511000835.operation(e,tp,eg,ep,ev,re,r,rp)
