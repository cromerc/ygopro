--Judgment Blaster
function c511001309.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_DESTROY)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetCost(c511001309.cost)
	e1:SetTarget(c511001309.target)
	e1:SetOperation(c511001309.activate)
	c:RegisterEffect(e1)
end
function c511001309.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511001309.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511001309.activate(e,tp,eg,ep,ev,re,r,rp)
	local sg=Duel.GetMatchingGroup(Card.IsDestructable,tp,LOCATION_MZONE,LOCATION_MZONE,nil)
