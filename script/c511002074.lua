...
function c511002074.initial_effect(c)
	...
	e1:SetTarget(c511002074.target)
	e1:SetOperation(c511002074.operation)
	c:RegisterEffect(e1)
	--Pierce
...
function c511002074.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chkc then return chkc:IsLocation(LOCATION_MZONE) and chkc:IsFaceup() end
	if chk==0 then return Duel.IsExistingTarget(Card.IsFaceup,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_EQUIP)
	Duel.SelectTarget(tp,Card.IsFaceup,tp,LOCATION_MZONE,LOCATION_MZONE,1,1,nil)
end
function c511002074.operation(e,tp,eg,ep,ev,re,r,rp)
