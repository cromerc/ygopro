...
function c170000113.initial_effect(c)
	...
	e1:SetValue(c170000113.vala)
	c:RegisterEffect(e1)
	--must attack
	local e2=Effect.CreateEffect(c)
	e2:SetType(EFFECT_TYPE_SINGLE)
	e2:SetCode(EFFECT_MUST_ATTACK)
	e2:SetCondition(c170000113.becon)
	c:RegisterEffect(e2)
	...
	e4:SetValue(c170000113.atkval)
	e4:SetTarget(c170000113.atktg)
	c:RegisterEffect(e4)
end
...
function c170000113.becon(e)
	return e:GetHandler():IsAttackable() 
		and Duel.IsExistingMatchingCard(c170000113.atkfilter,e:GetHandlerPlayer(),0,LOCATION_MZONE,1,nil)
end
function c170000113.atktg(e,c)
	return c:IsFaceup() and c:IsType(0x20000000)
end
function c170000113.atkval(e,c)
