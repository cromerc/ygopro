...
function c170000172.initial_effect(c)
	--pos change
	...
	e1:SetCountLimit(1)
	e1:SetTarget(c170000172.target)
	e1:SetOperation(c170000172.operation)
	c:RegisterEffect(e1)
end
function c170000172.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c170000172.operation(e,tp,eg,ep,ev,re,r,rp)
