...
function c170000115.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c170000115.target)
	e1:SetOperation(c170000115.activate)
	c:RegisterEffect(e1)
end
...
function c170000115.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(c170000115.filter,tp,LOCATION_GRAVE,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectTarget(tp,c170000115.filter,tp,LOCATION_GRAVE,0,1,1,nil)
