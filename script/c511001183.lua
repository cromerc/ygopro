--Tachyon Refresh
function c511001183.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511001183.target)
	e1:SetOperation(c511001183.activate)
	c:RegisterEffect(e1)
end
function c511001183.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511001183.activate(e,tp,eg,ep,ev,re,r,rp)
