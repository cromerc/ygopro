--Mano a Mano
function c511000832.initial_effect(c)
	...
	e2:SetOperation(c511000832.dop)
	c:RegisterEffect(e2)
	--selfdes
	...
	e3:SetCondition(c511000832.sdcon)
	c:RegisterEffect(e3)
end
function c511000832.sdcon(e)
...
function c511000832.dop(e,tp,eg,ep,ev,re,r,rp)
