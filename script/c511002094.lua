--スピード・ワールド 
function c511002094.initial_effect(c)
	...
	e2:SetOperation(c511002094.damop)
	c:RegisterEffect(e2)
	--add counter
	...
	e3:SetOperation(c511002094.ctop)
	c:RegisterEffect(e3)
	--activation
	...
	e4:SetValue(c511002094.aclimit)
	...
	e7:SetTarget(c511002094.aclimit2)
	c:RegisterEffect(e7)
	--lose counter
	...
	e8:SetOperation(c511002094.ctopx)
	c:RegisterEffect(e8)
	--
...
function c511002094.op(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if tc==nil then
		...
		if tc2==nil then
			local token=Duel.CreateToken(tp,511002094,nil,nil,nil,nil,nil,nil)		
