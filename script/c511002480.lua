...
c511002480.list={[44508094]=61257789,[70902743]=77336644,[6021033]=1764972,
				[31924889]=14553285,[23693634]=38898779,[95526884]=37169670}
function c511002480.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(1)
	return true
end
function c511002480.filter1(c,e,tp)
	local code=c:GetCode()
	local tcode=c511002480.list[code]
	return tcode and c:IsType(TYPE_SYNCHRO) and Duel.IsExistingMatchingCard(c511002480.filter2,tp,LOCATION_HAND+LOCATION_DECK,0,1,nil,tcode,e,tp)
end
...
function c511002480.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		return Duel.GetLocationCount(tp,LOCATION_MZONE)>-1
			and Duel.CheckReleaseGroup(tp,c511002480.filter1,1,nil,e,tp)
	end
	local rg=Duel.SelectReleaseGroup(tp,c511002480.filter1,1,1,nil,e,tp)
...
function c511002480.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local tcode=c511002480.list[code]
	local tc=Duel.SelectMatchingCard(tp,c511002480.filter2,tp,LOCATION_HAND+LOCATION_DECK,0,1,1,nil,tcode,e,tp):GetFirst()
