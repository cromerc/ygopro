--Service Ace
function c511000645.initial_effect(c)
	--remove
	...
	e1:SetTarget(c511000645.rmtg)
	e1:SetOperation(c511000645.rmop)
	c:RegisterEffect(e1)
end
function c511000645.rmtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511000645.rmop(e,tp,eg,ep,ev,re,r,rp)
