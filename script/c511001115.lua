...
function c511001115.initial_effect(c)
	...
	e3:SetTarget(c511001115.crystaltg)
	e3:SetOperation(c511001115.crystalop)
	c:RegisterEffect(e3)
	--damage reduce
	...
	e4:SetCondition(c511001115.rdcon)
	e4:SetOperation(c511001115.rdop)
	c:RegisterEffect(e4)
	--selfdes
...
function c511001115.crystaltg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511001115.crystalop(e,tp,eg,ep,ev,re,r,rp,chk)
	local c=e:GetHandler()
...
function c511001115.rdcon(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return ep~=tp and c==Duel.GetAttacker() and Duel.GetAttackTarget()==nil
		and c:GetEffectCount(EFFECT_DIRECT_ATTACK)<2 and Duel.GetFieldGroupCount(tp,0,LOCATION_MZONE)>0
end
function c511001115.rdop(e,tp,eg,ep,ev,re,r,rp)
