...
function c511000266.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and tc and tc:IsFaceup() and tc:IsRelateToEffect(e) then
		...
		e1:SetCondition(c511000266.rcon)
		...
		e2:SetCondition(c511000266.descon)
		e2:SetOperation(c511000266.desop)
...
function c511000266.rcon(e)
	return e:GetOwner():IsHasCardTarget(e:GetHandler())
end
function c511000266.descon(e,tp,eg,ep,ev,re,r,rp)
	local tc=e:GetHandler():GetFirstCardTarget()
	return not tc
end
function c511000266.desop(e,tp,eg,ep,ev,re,r,rp)
