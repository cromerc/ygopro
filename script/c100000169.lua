...
function c100000169.initial_effect(c)
	...
	e1:SetTarget(c100000169.target)
	e1:SetOperation(c100000169.operation)
	c:RegisterEffect(e1)
	--equip limit
...
function c100000169.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c100000169.operation(e,tp,eg,ep,ev,re,r,rp)
