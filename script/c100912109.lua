...
function c100912109.initial_effect(c)
	--activate
	...
	e2:SetDescription(aux.Stringid(100912109,1))
	...
	e2:SetTarget(c100912109.thtg)
	e2:SetOperation(c100912109.thop)
	c:RegisterEffect(e2)
end
function c100912109.filter(c)
