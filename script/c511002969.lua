--Slow Life
function c511002969.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetCondition(c511002969.condition)
	c:RegisterEffect(e1)
	...
	e2:SetCondition(c511002969.con1)
	...
	c:RegisterEffect(e3)
	local e4=e2:Clone()
	e4:SetCondition(c511002969.con2)
	e4:SetCode(EFFECT_CANNOT_SPECIAL_SUMMON)
	c:RegisterEffect(e4)
	--disable summon (opponent)
	local e5=e2:Clone()
	e5:SetCondition(c511002969.con3)
