...
function c100000116.arcanareg(c,coin)
	...
	if c:GetFlagEffectLabel(100000116)==1 then
		e1:SetTarget(c100000116.sptg)
		e1:SetOperation(c100000116.spop)
	else	
		e1:SetTarget(c100000116.tgtg)
		e1:SetOperation(c100000116.tgop)
	end
	e1:SetReset(RESET_EVENT+0x1ff0000)
	c:RegisterEffect(e1)
end
function c100000116.sptg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c100000116.spop(e,tp,eg,ep,ev,re,r,rp)
...
function c100000116.tgtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c100000116.tgop(e,tp,eg,ep,ev,re,r,rp)
	local sg=Duel.GetMatchingGroup(Card.IsDestructable,tp,LOCATION_MZONE,LOCATION_MZONE,nil)
