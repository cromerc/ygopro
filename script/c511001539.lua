...
function c511001539.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(24919805,0))
	...
	e3:SetTarget(c511001539.fustg)
	e3:SetOperation(c511001539.fusop)
	c:RegisterEffect(e3)
end
...
function c511001539.fustg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
...
function c511001539.fusop(e,tp,eg,ep,ev,re,r,rp)
	local chkf=Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and PLAYER_NONE or tp
