--Panic Wave
function c511000874.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511000874.target)
	e1:SetOperation(c511000874.activate)
	c:RegisterEffect(e1)
end
function c511000874.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511000874.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) then
		...
		e1:SetTarget(c511000874.distarget)
		...
		e2:SetOperation(c511000874.disoperation)
		...
		e3:SetTarget(c511000874.distarget)
		...
		e4:SetTarget(c511000874.distarget)
		e4:SetReset(RESET_PHASE+PHASE_END)
		Duel.RegisterEffect(e4,tp)
	end
end
function c511000874.distarget(e,c)
	return c~=e:GetHandler() and (c:IsType(TYPE_CONTINUOUS) or c:IsType(TYPE_EFFECT))
end
function c511000874.disoperation(e,tp,eg,ep,ev,re,r,rp)
