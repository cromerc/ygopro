...
function c511002684.initial_effect(c)
	...
	e1:SetTarget(c511002684.target)
	e1:SetOperation(c511002684.operation)
	c:RegisterEffect(e1)
	--Atk up
...
function c511002684.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511002684.operation(e,tp,eg,ep,ev,re,r,rp)
