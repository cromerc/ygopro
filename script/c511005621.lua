--illlusionist faceless mage (DOR)
--scripted by GameMaster (GM)
function c511005621.initial_effect(c)
	--battled
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e1:SetCode(EVENT_BATTLED)
	e1:SetCondition(c511005621.condition)
	e1:SetOperation(c511005621.atop)
	c:RegisterEffect(e1)
end
function c511005621.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c511005621.atop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
