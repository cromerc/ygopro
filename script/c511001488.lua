--Chaos Life
function c511001488.initial_effect(c)
	--reflect
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_CHAINING)
	e1:SetCondition(c511001488.condition)
	e1:SetOperation(c511001488.operation)
	c:RegisterEffect(e1)
end
function c511001488.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c511001488.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetLabel(cid)
	e1:SetValue(c511001488.refcon)
	e1:SetReset(RESET_CHAIN)
	Duel.RegisterEffect(e1,tp)
end
function c511001488.refcon(e,re,r,rp,rc)
