...
function c511000093.initial_effect(c)
	--Activate
	...
	e1:SetCondition(c511000093.con)
	e1:SetTarget(c511000093.target)
	e1:SetOperation(c511000093.activate)
	c:RegisterEffect(e1)
end
function c511000093.con(e,tp,eg,ep,ev,re,r,rp)
	local tc=Duel.GetFieldCard(tp,LOCATION_SZONE,5)
	return tc:GetCounter(0x91)>1
end
function c511000093.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511000093.activate(e,tp,eg,ep,ev,re,r,rp)
