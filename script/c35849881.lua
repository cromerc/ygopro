...
function c35849881.initial_effect(c)
	--Activate
	...
	e1:SetCost(c35849881.cost)
	e1:SetTarget(c35849881.target)
	e1:SetOperation(c35849881.activate)
	c:RegisterEffect(e1)
	end
	function c35849881.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,nil,2,nil) end
	local rg=Duel.SelectReleaseGroup(tp,nil,2,2,nil)
	Duel.Release(rg,REASON_COST)
end
function c35849881.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c35849881.activate(e,tp,eg,ep,ev,re,r,rp)
