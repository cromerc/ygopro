--エクスチェンジ
function c511000691.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetTarget(c511000691.target)
	e1:SetOperation(c511000691.activate)
	c:RegisterEffect(e1)
end
function c511000691.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511000691.activate(e,tp,eg,ep,ev,re,r,rp)
