...
function c100004001.spfilter(c,e,tp)
	return c:IsCode(100004002) and c:IsCanBeSpecialSummoned(e,0,tp,true,true)
end
...
function c100004001.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.SelectMatchingCard(tp,c100004001.spfilter,tp,LOCATION_HAND+LOCATION_DECK,0,1,1,nil,e,tp)
	local tc=g:GetFirst()
	if tc then
