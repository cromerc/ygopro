--Wonder Cloud
function c511000381.initial_effect(c)
	--Activate
	...
	e1:SetCost(c511000381.cost)
	e1:SetTarget(c511000381.target)
	e1:SetOperation(c511000381.operation)
	c:RegisterEffect(e1)
end
function c511000381.cost(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511000381.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511000381.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.Draw(p,ct,REASON_EFFECT) then
		...
		if Duel.Remove(g,POS_FACEUP,REASON_EFFECT) then
			...
			e1:SetTarget(c511000381.distarget)
			e1:SetReset(RESET_PHASE+PHASE_END)
			Duel.RegisterEffect(e1,tp)
		end
	end
end
function c511000381.distarget(e,c)
