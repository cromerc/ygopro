--ジュラシックワールド
function c511002874.initial_effect(c)
	--Activate
	...
	e4:SetValue(c511002874.efilter)
	c:RegisterEffect(e4)
	...
	e5:SetCondition(c511002874.cbcon)
	e5:SetOperation(c511002874.cbop)
	c:RegisterEffect(e5)
end
function c511002874.efilter(e,te)
	return te:IsActiveType(TYPE_TRAP) and e:GetOwnerPlayer()~=te:GetOwnerPlayer()
end
function c511002874.cbcon(e,tp,eg,ep,ev,re,r,rp)
