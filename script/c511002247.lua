--Escape
function c511002247.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_TOHAND)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetTarget(c511002247.target)
	e1:SetOperation(c511002247.activate)
	c:RegisterEffect(e1)
end
function c511002247.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511002247.activate(e,tp,eg,ep,ev,re,r,rp)
