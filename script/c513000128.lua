...
function c513000128.initial_effect(c)
	...
	e3:SetTarget(c513000128.atktg2)
...
function c513000128.atktg(e,c)
	return c:IsAttribute(e:GetLabel()) and c:IsAttackPos()
		and Duel.IsExistingMatchingCard(c513000128.adval,c:GetControler(),0,LOCATION_MZONE,1,nil,e:GetLabel())
end
function c513000128.atktg2(e,c)
