...
function c95000063.initial_effect(c)
	...
	e7:SetTarget(c95000063.sfilter)
	c:RegisterEffect(e7)
	-- Add Action Card
	...
	e9:SetTarget(aux.TargetBoolFunction(Card.IsRace,RACE_PSYCHO))
	e9:SetCondition(c95000063.Fcond)
	e9:SetValue(c95000063.esop)
	c:RegisterEffect(e9)
	--lpcost replace
	local e10=Effect.CreateEffect(c)
	e10:SetDescription(aux.Stringid(85668449,0))
	e10:SetType(EFFECT_TYPE_FIELD+EFFECT_TYPE_CONTINUOUS)
	e10:SetRange(LOCATION_SZONE)
	e10:SetCode(EFFECT_LPCOST_REPLACE)
	e10:SetCondition(c95000063.lrcon)
	e10:SetOperation(c95000063.lrop)
	c:RegisterEffect(e10)
	--damage
	local e11=Effect.CreateEffect(c)
	e11:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e11:SetCode(EVENT_LEAVE_FIELD_P)
	e11:SetCondition(c95000063.Fcond)
	e11:SetOperation(c95000063.damp)
	c:RegisterEffect(e11)
	local e12=Effect.CreateEffect(c)
	e12:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_CONTINUOUS)
	e12:SetCode(EVENT_LEAVE_FIELD)
	e12:SetOperation(c95000063.damop)
	e12:SetCondition(c95000063.Fcond)
	e12:SetLabelObject(e12)
...
function c95000063.sfilter(e,c,tp)
...
function c95000063.returnop(e)
	...
	e4:SetTarget(c95000063.sfilter)
	e4:SetReset(RESET_EVENT+0x1fe0000)
	fc:RegisterEffect(e4)
	fc:RegisterFlagEffect(195000063,RESET_EVENT+0x1fe0000,0,1)
	end
end
function c95000063.Fcond(e)
	local f1=Duel.GetFieldCard(0,LOCATION_SZONE,5)
	local f2=Duel.GetFieldCard(1,LOCATION_SZONE,5)
	return (f1:GetFlagEffect(195000063)==0) and (f2:GetFlagEffect(195000063)==0)
end
...
function c95000063.lrcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return rc:IsLocation(LOCATION_MZONE) and rc:IsRace(RACE_PSYCHO) and (f1:GetFlagEffect(195000063)==0) and (f2:GetFlagEffect(195000063)==0)
end
