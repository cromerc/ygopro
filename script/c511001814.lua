...
function c511001814.filter(c,e,tp,m)
	local cd=c:GetCode()
	if cd~=70345785 or not c:IsCanBeSpecialSummoned(e,SUMMON_TYPE_RITUAL,tp,true,false) 
...
function c511001814.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local tg=Duel.SelectMatchingCard(tp,c511001814.filter,tp,0x33,0,1,1,nil,e,tp,mg)
