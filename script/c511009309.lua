--White Line
function c511009309.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511009309.target)
	e1:SetOperation(c511009309.activate)
	c:RegisterEffect(e1)
end
function c511009309.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511009309.activate(e,tp,eg,ep,ev,re,r,rp)
...
function c511009309.damval(e,re,val,r,rp,rc)
