--Ｓｐ－スケープ·ゴート
function c100100510.initial_effect(c)
	--Activate
	...
	e1:SetCost(c100100510.cost)
	e1:SetTarget(c100100510.target)
	e1:SetOperation(c100100510.activate)
	c:RegisterEffect(e1)
end
function c100100510.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	local tc=Duel.GetFieldCard(tp,LOCATION_SZONE,5)
	if chk==0 then return tc:IsCanRemoveCounter(tp,0x91,4,REASON_COST) and not Duel.CheckSummonActivity(tp)
	...
	e1:SetLabelObject(e)
	e1:SetTarget(c100100510.sumlimit)
...
function c100100510.sumlimit(e,c,sump,sumtype,sumpos,targetp,se)
	return e:GetLabelObject()~=se
end
function c100100510.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c100100510.activate(e,tp,eg,ep,ev,re,r,rp)
