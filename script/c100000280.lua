...
function c100000280.initial_effect(c)
	...
	e4:SetCondition(c100000280.damcon)
	e4:SetTarget(c100000280.damtg)
	e4:SetOperation(c100000280.damop)
	c:RegisterEffect(e4)
end
function c100000280.damcon(e,tp,eg,ep,ev,re,r,rp)
	local des=eg:GetFirst()
	local rc=des:GetReasonCard()
	return des:IsType(TYPE_MONSTER) and rc:IsRelateToBattle() and rc:IsLevelAbove(10)
end
function c100000280.damtg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c100000280.damop(e,tp,eg,ep,ev,re,r,rp)
