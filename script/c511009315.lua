--Multiplying Thorns
function c511009315.initial_effect(c)
	--Activate
	...
	e2:SetCondition(c511009315.descon)
	c:RegisterEffect(e2)
	--damage
	...
	e3:SetCountLimit(1)
	e3:SetTarget(c511009315.damtg)
	e3:SetOperation(c511009315.damop)
	c:RegisterEffect(e3)
	...
	e5:SetOperation(c511009315.damop2)
	c:RegisterEffect(e5)
end
...
function c511009315.damop(e,tp,eg,ep,ev,re,r,rp)
...
function c511009315.damop2(e,tp,eg,ep,ev,re,r,rp)
	local count=0
	local c=eg:GetFirst()
	while c~=nil do
