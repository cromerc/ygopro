...
function c100000067.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local g1=Duel.GetMatchingGroup(c100000067.filter,tp,0x13,0,nil,4545683,e,tp)
	local g2=Duel.GetMatchingGroup(c100000067.filter,tp,0x13,0,nil,100000062,e,tp)
	local g3=Duel.GetMatchingGroup(c100000067.filter,tp,0x13,0,nil,100000063,e,tp)
	local g4=Duel.GetMatchingGroup(c100000067.filter,tp,0x13,0,nil,100000064,e,tp)
	local g5=Duel.GetMatchingGroup(c100000067.filter,tp,0x13,0,nil,100000065,e,tp)
