...
function c511000823.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckReleaseGroup(tp,c511000823.costfilter,1,nil) end
	local g=Duel.SelectReleaseGroup(tp,c511000823.costfilter,1,1,nil)
