--Plucked Wing
function c511000667.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511000667.target)
	e1:SetOperation(c511000667.activate)
	c:RegisterEffect(e1)
end
function c511000667.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511000667.activate(e,tp,eg,ep,ev,re,r,rp)
