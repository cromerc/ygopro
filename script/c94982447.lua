...
function c94982447.spfilter(c,e,tp)
	return (c:IsSetCard(0xf9) or c:IsCode(30539496,34079868,82321037,87765315,96746083)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c94982447.tgtg(e,c)
	return (c:IsSetCard(0xf9) or c:IsCode(30539496,34079868,82321037,87765315,96746083)) and c~=e:GetHandler()
end
