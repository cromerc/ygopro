--Amazoness Charm
function c511001871.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511001871.target)
	e1:SetOperation(c511001871.activate)
	c:RegisterEffect(e1)
end
function c511001871.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511001871.activate(e,tp,eg,ep,ev,re,r,rp)
