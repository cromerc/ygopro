--Ｓｐ－迷える仔羊
function c100100009.initial_effect(c)
	--Activate
	local e1=Effect.CreateEffect(c)
	e1:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e1:SetType(EFFECT_TYPE_ACTIVATE)
	e1:SetCode(EVENT_FREE_CHAIN)
	e1:SetCost(c100100009.cost)
	e1:SetTarget(c100100009.target)
	e1:SetOperation(c100100009.activate)
	c:RegisterEffect(e1)
end
function c100100009.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e1:SetLabelObject(e)
	e1:SetTarget(c100100009.sumlimit)
