...
function c100000445.costfilter(c,e,tp)
	return c:IsFaceup() and c:IsCode(100000058) and c:IsAbleToGraveAsCost()
end
function c100000445.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c100000445.costfilter,tp,LOCATION_MZONE,0,1,nil) end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g=Duel.SelectMatchingCard(tp,c100000445.costfilter,tp,LOCATION_MZONE,0,1,1,nil)
