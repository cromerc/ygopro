--Stealth
function c511002239.initial_effect(c)
	--flip
	...
	e1:SetCountLimit(1)
	e1:SetTarget(c511002239.target)
	e1:SetOperation(c511002239.operation)
	c:RegisterEffect(e1)
end
function c511002239.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	if chk==0 then return Duel.IsExistingMatchingCard(Card.IsFacedown,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_POSITION,nil,1,0,0)
end
function c511002239.operation(e,tp,eg,ep,ev,re,r,rp,chk)
