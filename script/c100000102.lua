...
function c100000102.condition(e,tp,eg,ep,ev,re,r,rp)
	return (Duel.GetCurrentPhase()~=PHASE_DAMAGE or not Duel.IsDamageCalculated()) 
		and Duel.IsExistingMatchingCard(c100000102.cfilter,tp,LOCATION_ONFIELD,0,1,nil)
end
function c100000102.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetCustomActivityCount(100000102,tp,ACTIVITY_ATTACK)==0 end
