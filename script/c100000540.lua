...
function c100000164.indtg(e,c)
	return (c:IsCode(97811903) or c:IsCode(100000160) or c:IsCode(100000161) or c:IsCode(100000162) or c:IsCode(100000163)) and c:GetBattlePosition()==POS_FACEUP_ATTACK
end
