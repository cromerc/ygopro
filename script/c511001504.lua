--Dark Tournament
function c511001504.initial_effect(c)
	--Activate
	...
	e1:SetTarget(c511001504.target)
	e1:SetOperation(c511001504.activate)
	c:RegisterEffect(e1)
end
function c511001504.target(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c511001504.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if sg:GetCount()>0 then
		...
		be:SetCondition(c511001504.becon)
		be:SetReset(RESET_PHASE+PHASE_END)
		Duel.RegisterEffect(be,tp)
	end
end
function c511001504.tg(e,c)
	return c:IsPosition(POS_FACEUP_ATTACK)
end
function c511001504.becon(e)
