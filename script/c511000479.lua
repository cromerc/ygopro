--Relativity Field
function c511000479.initial_effect(c)
	...
	e2:SetLabel(lp1)
	e2:SetCondition(c511000479.lpcon1)
	e2:SetOperation(c511000479.lpop1)
	c:RegisterEffect(e2)
	--lose lp 2
	...
	e3:SetLabel(lp2)
	e3:SetCondition(c511000479.lpcon2)
	e3:SetOperation(c511000479.lpop2)
	c:RegisterEffect(e3)
	--lose atk
	...
	e4:SetCondition(c511000479.atkcon1)
	e4:SetOperation(c511000479.atkop1)
	c:RegisterEffect(e4)
	--lose atk 2
	...
	e5:SetCondition(c511000479.atkcon2)
	e5:SetOperation(c511000479.atkop2)
	c:RegisterEffect(e5)
end
function c511000479.lpcon1(e,tp,eg,ep,ev,re,r,rp)
...
function c511000479.lpcon2(e,tp,eg,ep,ev,re,r,rp)
	local p=e:GetHandler():GetControler()
...
function c511000479.atkop2(e,tp,eg,ep,ev,re,r,rp)
	local p=e:GetHandler():GetControler()
