--D2シールド
function c511002879.initial_effect(c)
	--Activate
	...
	e1:SetCondition(c511002879.condition)
	e1:SetTarget(c511002879.target)
	e1:SetOperation(c511002879.activate)
	c:RegisterEffect(e1)
end
function c511002879.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetCurrentPhase()~=PHASE_DAMAGE or not Duel.IsDamageCalculated()
end
function c511002879.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
...
function c511002879.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		e3:SetOperation(c511002879.drop)
		e3:SetReset(RESET_EVENT+0x1fe0000)
		tc:RegisterEffect(e3)
	end
end
function c511002879.drop(e,tp,eg,ep,ev,re,r,rp)
