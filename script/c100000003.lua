...
function c100000003.initial_effect(c)
	...
	c:RegisterEffect(e4)
	local e5=e3:Clone()
	e5:SetCondition(c100000003.damcon)
	...
	e6:SetCondition(c100000003.thcon)
	e6:SetOperation(c100000003.thop)
	c:RegisterEffect(e6)
	--to deck
...
function c100000003.damcon(e)
	return e:GetHandler():IsAttackPos()
end
function c100000003.thcon(e,tp,eg,ep,ev,re,r,rp)
	local p=e:GetHandler():GetControler()
	return e:GetHandler():GetBattledGroupCount()>0 and Duel.GetLP(p)<Duel.GetLP(1-p)
end
function c100000003.thop(e,tp,eg,ep,ev,re,r,rp)
	local p=e:GetHandler():GetControler()
	Duel.Damage(1-tp,Duel.GetLP(1-p)-Duel.GetLP(p),REASON_EFFECT)
end
